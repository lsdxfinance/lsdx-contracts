...
contract UniswapV2PairOracle {
  ...
  constructor(address _pairAddress) {
    ...
    require(reserve0 != 0 && reserve1 != 0, 'UniswapV2PairOracle: NO_RESERVES'); // ensure that there's liquidity in the pair
  }
  ...
  function update() external {
    ...
    require(timeElapsed >= PERIOD, 'UniswapV2PairOracle: PERIOD_NOT_ELAPSED');
