 ...
 */
contract AToken is ScaledBalanceTokenBase, IAToken {
  using WadRayMath for uint256;
  using SafeCast for uint256;
  ...
  function transferUnderlyingTo(address target, uint256 amount) external virtual onlyPool {
   ...
   */
  // function DOMAIN_SEPARATOR() public view override(IAToken) returns (bytes32) {
   ...
   */
  // function nonces(address owner) public view override(IAToken) returns (uint256) {
  //   return super.nonces(owner);
  // }

  function _EIP712BaseId() internal view returns (string memory) {
    return name();
  }
